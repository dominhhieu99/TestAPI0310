...
public class PhuongXaActivity extends AppCompatActivity {
    ...
    private void initAction() {
        adapter.setOnClickListener(new Adapter.OnClickListener() {
            ...
            public void onClick(RespondAfter.ListArea listArea) {
                Toast.makeText(PhuongXaActivity.this, "" + listArea.getFullName(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getData() {
        ...
        Gson gson = new Gson();
        String json = gson.toJson(new RequestAfter("7", "C", parentCode));
        ...
        LienvietRetrofit.getInstance().RESPOND_CALL(requestAfter).enqueue(new Callback<Respond>() {
            ...
            public void onResponse(Call<Respond> call, Response<Respond> response) {
                if (response.body() != null) {
                    ...
                    Toast.makeText(PhuongXaActivity.this, "Bị lỗi refresh lại trang", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Respond> call, Throwable t) {
                Toast.makeText(PhuongXaActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                srlRefresh.setRefreshing(false);
            }
        });
    }
